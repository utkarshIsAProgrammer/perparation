import { w as withoutTrailingSlash, k as generateId, p as parseProviderOptions, d as combineHeaders, e as resolve, f as postJsonToApi, g as createJsonResponseHandler, h as createEventSourceResponseHandler, l as loadApiKey, U as UnsupportedFunctionalityError, i as convertUint8ArrayToBase64, j as createJsonErrorResponseHandler, T as TooManyEmbeddingValuesForCallError } from './dist-DmVdNrSg.mjs';
import { z } from 'zod';
import './index.mjs';
...
//#region ../../../../../setup-pnpm/node_modules/.bin/store/v11/links/@ai-sdk/google/1.2.22/41ebc37da5c0cc776491dfd3b069573584edf95feef55c6898689a7ddd0d4085/node_modules/@ai-sdk/google/dist/index.mjs
function convertJSONSchemaToOpenAPISchema(jsonSchema) {
	if (isEmptyObjectSchema(jsonSchema)) return;
...
var contentSchema = z.object({ parts: z.array(z.union([
	z.object({ functionCall: z.object({
		name: z.string(),
		args: z.unknown()
	}) }),
	z.object({ inlineData: z.object({
		mimeType: z.string(),
		data: z.string()
	}) }),
	z.object({
...
var groundingMetadataSchema = z.object({
	...
	retrievalMetadata: z.union([z.object({ webDynamicRetrievalScore: z.number() }), z.object({})]).nullish()
});
...
var googleGenerativeAITextEmbeddingResponseSchema = z.object({ embeddings: z.array(z.object({ values: z.array(z.number()) })) });
